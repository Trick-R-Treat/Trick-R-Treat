...
public class BlockHit : MonoBehaviour
{
    ...
    private void Hit()
    {
        ...
        spriteRenderer.enabled = true;  // Unity -> Hierarchy -> MysteryBlock -> Inspector -> ota täppä pois Sprite Rendererin nimen vierestä, niin MysteryBoxista tulee näkymätön. 

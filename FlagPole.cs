...
public class FlagPole : MonoBehaviour
{
    ...
    {
        while (Vector3.Distance(subject.position, destination) > 0.128f)  //Kun vectorin et‰isyys kohteen sijainnin ja m‰‰r‰np‰‰n v‰lill‰ on suurempi kuin kahdeksasosa yksikˆst‰... kohde on liian kaukana, eik‰ se ole tavoittanut m‰‰r‰np‰‰t‰. T‰ss‰ tapauksessa jatketaan animointia.
        {

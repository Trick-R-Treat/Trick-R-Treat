...
public class BlockHit : MonoBehaviour
{
    ...
    private void Hit()
    {
        ...
        spriteRenderer.enabled = true;  //Lisää tämä koodi ja Unity -> Hierarchy -> MysteryBlock -> Inspector -> ota täppä pois Sprite Rendererin nimen vierestä, niin MysteryBoxista tulee näkymätön. 

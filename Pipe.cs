...
public class Pipe : MonoBehaviour
{
    ...
    {
        player.GetComponent<PlayerMovement>().enabled = false;  // Poistetaan Marion liikeanimointi k‰ytˆst‰.
        ...
        player.GetComponent<PlayerMovement>().enabled = true;  // Otetaan Marion liikeanimointi k‰yttˆˆn.
    }
